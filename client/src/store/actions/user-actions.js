...
export const onSignup =
  ...
  async (dispatch) => {
    try {
      const response = await PostData("/customner/customer/signup", {
        email,
        password,
        phone,
      });
...
export const onLogin =
  ...
  async (dispatch) => {
    try {
      const response = await PostData("/customer/customer/login", {
        email,
        password,
      });
...
export const onViewProfile = () => async (dispatch) => {
  try {
    const response = await GetData("/customer/customer/profile");
